	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a href="all-order-manage-list.html"> Management</a></li>
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-2 title">Time</div>
					<div class="col-md-4 data">
					...
					<div class="col-md-2 title">Travellers</div>
					<div class="col-md-4 data">
				...
				<table id="dataList"
					...
					<thead>
						<tr>
							...
							<th class="">Gender</th>
							<th class="">Tel_Num</th>
							<th class="">Credential_Type </th>
							<th class="">Credential_Num</th>
						</tr>
					</thead>
					<tbody>
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-2 title">Contact_Person</div>
					<div class="col-md-4 data text">${orders.member.name}</div>

					<div class="col-md-2 title">Tel_Num</div>
			...
			<!--联系人信息/--> <!--费用信息--> <c:if test="${orders.orderStatus==1}">
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-2 title">Payment_Type</div>
						<div class="col-md-4 data text">Online-${orders.payTypeStr}</div>
